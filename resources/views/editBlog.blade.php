            ...
            <form action="{{url('update')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  <input class="form-control" name="bTitle" value="{{$item->title}}" placeholder="Title"/>
                </div>
                <div class="form-group">
                  <input class="form-control" name="bDescriptionn" value="{{$item->description}}" placeholder="Short Description"/>
                </div>
                <div class="form-group">
                  <input type="file" class="form-control" name="bImage" value="{{$item->image}}"  />
                </div>
                ...
                <div class="form-group">
                  <textarea id="compose-textarea" name="bFullDes"  class="form-control" style="height: 300px" placeholder="Full Description">{{$item->full_description}}</textarea>
                </div>
                ...
                <div class="input-group margin">
                  ...
                  <input type="text" name="tweet" value="{{$item->tweet}}" class="form-control">
                </div><!-- /input-group -->
